...
public class RTextViewHelper extends RBaseHelper<TextView> {
    ...
    private boolean textColorVariable = true ;
    public RTextViewHelper setTextColorVariable(boolean variable){

        textColorVariable = variable;

        if (mTextColorPressed != 0 &&mTextColorNormal!=0&&mTextColorUnable!=0) {
